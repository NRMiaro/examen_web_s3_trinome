    ...
    <div class="card-body">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            ...
            <div style="padding: 16px; background: #f8f9fa; border-radius: 8px;">
                ...
                <p style="font-size: 1.3em; margin: 8px 0 0 0; color: #2196F3;" id="dons-financiers">
        ...
        fetch('<?= BASE_URL ?>/api/recap')
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('dons-financiers').textContent = formatNumber(recap.dons_financiers_total) + ' Ar';
